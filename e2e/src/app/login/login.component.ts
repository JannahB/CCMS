...
export class LoginComponent implements OnInit {
  ...
  constructor(
    ...
    private autoLogoutService: AutoLogoutService
      ...
      //Stops the service in case the user didn't logout before closing the application
      if(AuthorizationInterceptor.authToken == null){
          this.autoLogoutService.stopService();
      }
  }
  ...
  private handleAuthenticationComplete(loginResult): void {
    ...
    //Initializes auto logout service
    this.autoLogoutService.setMaxUserInactivity(loginResult.maxUserInactivityInterval);
    this.autoLogoutService.setLastActionCheckInterval(loginResult.lastActionCheckInterval);
    this.autoLogoutService.startService();
